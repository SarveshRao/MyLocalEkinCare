class Customers::PaymentSuccessController < CustomerAppController
  ...
  def index
    ...
    if @payment_details.save!
      ...
      Notification.customer_appointment_success(appointment_body, appointment_dental, appointment_vision, @name, @package_detail.name, @package_detail.mrp, @package_detail.selling_price, @package_detail.discount, customer_address, @customer.email, dental_address, vision_address, provider_dental, provider_vision, url).deliver!
    end
  end
end