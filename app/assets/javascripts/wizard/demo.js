...
$(function(){
    ...
    $('input[name="chk-father_medicals"],input[name="chk-mother_medicals"],input[name="blood_group"],input[name="smoke"],input[name="exercise"],input[name="alcohol"]').on('change',function(){
        enable_next();
    });
    $('#height_tab,#weight_tab,#waist_tab').find('input').on('change',function(){
        enable_next();
    });
