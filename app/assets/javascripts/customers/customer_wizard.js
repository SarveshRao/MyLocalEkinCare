...
if ($('#customer-info-wizard').length > 0) {
            ...
            success: function (result) {
                ...
                if ('blood_sugar_id' in result) {
                    $('div .tab-content .tab-pane').each(function () {
                            if (this.id == result.blood_sugar_id) {
    ...
    $("#height_weight_next").click(function () {
        ...
        else if (insert_data('/customers/customer_information/update_customer_vitals', 'PUT', {
                'undefined': {
                    'weight': weight,
                    'feet': feet,
                    'inches': inches
    ...
    $("#activities_next").click(function () {
        ...
        else if (insert_data('/customers/customer_information/update', 'POST', {
                'customer': {
                    'smoke': smoke_status,
                    'alcohol': alcohol_status,
                    'frequency_of_exercise': exercise_status
                }
            }) == true) {
    ...
    $("#family_medical_history_next").click(function () {
        ...
        else if (insert_data("/customers/family_medical_histories", "POST", {
                family_medical_history: {relation: 'Mother'},
                'chk-family_medicals': mother_health_history
            }) &&
            insert_data("/customers/family_medical_histories", "POST", {
                family_medical_history: {relation: 'Father'},
                'chk-family_medicals': father_health_history
            })) {
    ...
    $('#water_intake_next').click(function () {
        ...
        if (water_intake_id == null) {
            ...
            $("#blood_sos_error").removeClass('hide')
                ...
                'customer': {
                    'hydrocare_subscripted': water_intake_id,
                    'blood_sos_subscripted': blood_sos_id
                }
            }) == true) {
    ...
    $("#health_information_finish").click(function () {
        ...
        if (systolic == '') {
            ...
            insert_data("/customers/customer_lab_results/edit", "PUT", {
                undefined: {
                    blood_pressure: {
                        systolic: systolic,
                        diastolic: diastolic
            ...
            $('#Fasting_blood_sugar_id').html(blood_sugar);
