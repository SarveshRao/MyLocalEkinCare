...
eKincare = {
  setup: function() {
    return eKincare.faqToggles();
  },
  faqToggles: function() {
    var $faqTrigger, faqContent;
    $faqTrigger = $(".faq__trigger");
    faqContent = ".faq__content";
    return $faqTrigger.on("click", function(e) {
      var elem;
      e.preventDefault();
      elem = $(this).next(faqContent);
      $(faqContent).not(elem).slideUp();
      elem.slideToggle();
      $faqTrigger.removeClass("active");
      if ($(this).hasClass("active")) {
        return $faqTrigger.removeClass("active");
      } else {
