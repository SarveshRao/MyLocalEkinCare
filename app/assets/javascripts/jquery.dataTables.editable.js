...
(function ($) {
    ...
    function addModal(){
        var $modal = $('<div class="modal-backdrop" style="opacity:0.4;z-index: 0"></div>');
        $('.ui-dialog').css({'z-index':'99999'});
        $('.ui-widget-header').text(properties.sHeaderTitle);
        $('.ui-widget-header').css({'background':'#f9fafc','border':'#eaeef1', 'color': '#000'});
    ...
    $.fn.makeEditable = function (options) {
        ...
        var defaults = {
            ...
            sHeaderTitle: "formAddNewRowHeader",
        ...
        return this.each(function () {
            ...
            if (oAddNewRowForm.length != 0) {
                ...
                if (oConfirmRowAddingButton.length == 0) {
                    oAddNewRowForm.append("<button class='m-r btn btn-primary' id='" + properties.sAddNewRowOkButtonId + "'>Save</button>");
                    oConfirmRowAddingButton = $("#" + properties.sAddNewRowOkButtonId, oAddNewRowForm);
                }
                ...
                if (oCancelRowAddingButton.length == 0) {
                    oCancelRowAddingButton = oAddNewRowForm.append("<button class='m-r btn btn-default' id='" + properties.sAddNewRowCancelButtonId + "'>Cancel</button>");
                    oCancelRowAddingButton = $("#" + properties.sAddNewRowCancelButtonId);
                }
            ...
            $("tbody", oTable).click(function (event) {
               ...
               // input.css({height:'300px!important'});

                //$('tr td input').replaceWith('<textarea/>');
