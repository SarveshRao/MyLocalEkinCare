(function (q, e) {
  ...
  function v() {
    ...
    if (this._introItems.length <= this._currentStep)"function" === typeof this._introCompleteCallback && this._introCompleteCallback.call(this), s.call(this, this._targetElement); else {
  ...
  function s(b) {
    ...
    if ((b = document.querySelectorAll(".introjs-fixParent")) && 0 < b.length)for (var c = b.length - 1; 0 <= c; c--)b[c].className = b[c].className.replace(/introjs-fixParent/g,
        "").replace(/^\s+|\s+$/g, "");
  ...
  function t(b) {
    ...
    if (null != d) {
      ...
      if (k && 0 < k.length)for (a = k.length - 1; 0 <= a; a--)k[a].className = k[a].className.replace(/introjs-fixParent/g, "").replace(/^\s+|\s+$/g, "");
  ...
  function B(b) {
    ...
    if ("body" === b.tagName.toLowerCase())c += "top: 0;bottom: 0; left: 0;right: 0;position: fixed;", a.setAttribute("style", c); else {
      var f = p(b);
  ...
  u.fn = e.prototype = {clone: function () {
    ...
    a:{
      var b = this._targetElement,
          a = [], c = this;
      if (this._options.steps)for (var d = [], f = 0, d = this._options.steps.length; f < d; f++) {
        ...
        f = n = 0;
        for (e = d.length; f < e; f++)if (h = d[f], null == h.getAttribute("data-step")) {
          for (; "undefined" != typeof a[n];)n++;
      ...
      B.call(c, b) && (v.call(c),
        ...
        if (27 === a.keyCode && !0 == c._options.exitOnEsc)s.call(c, b), void 0 != c._introExitCallback && c._introExitCallback.call(c); else if (37 === a.keyCode)x.call(c); else if (39 === a.keyCode || 13 === a.keyCode)v.call(c), a.preventDefault ? a.preventDefault() : a.returnValue = !1
    ...
    if ("function" === typeof b)this._introExitCallback =
        b; else throw Error("Provided callback for onexit was not a function.");
    return this
  }};
  return q.introJs = u
});
