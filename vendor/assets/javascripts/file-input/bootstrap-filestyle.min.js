...
(function (b) {
  ...
  c.prototype = {clear: function () {
    ...
    this.$element.css({position: "fixed", left: "-500px"}).after(this.$elementFilestyle);
  ...
  b.fn.filestyle = function (e, d) {
    var g = "", f = this.each(function () {
      if (b(this).attr("type") === "file") {
        var i = b(this), j = i.data("filestyle"), h = b.extend({}, b.fn.filestyle.defaults, e, typeof e === "object" && e);
        if (!j) {
  ...
  b.fn.filestyle.defaults = {buttonText: "Choose file", input: true, icon: true, classButton: "btn", classInput: "input-large", classIcon: "icon-folder-open"};
  b.fn.filestyle.noConflict = function () {
    b.fn.filestyle = a;
    return this
  };
  b(".filestyle").each(function () {
    var e = b(this), d = {buttonText: e.attr("data-buttonText"), input: e.attr("data-input") === "false" ? false : true, icon: e.attr("data-icon") === "false" ? false : true, classButton: e.attr("data-classButton"), classInput: e.attr("data-classInput"), classIcon: e.attr("data-classIcon")};
    e.filestyle(d)
  })
})(window.jQuery);
